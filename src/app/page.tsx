        ...
        <div className="container relative grid min-h-[calc(100vh-4rem)] items-center gap-10 py-14 md:grid-cols-[1.05fr_0.95fr] md:py-20">
          <div className="max-w-3xl space-y-7">
            ...
            <p className="max-w-2xl text-lg leading-8 text-muted-foreground md:text-xl">
              Browse a richer book library with top-rated picks, sharp recommendations, and a
              checkout flow that feels as smooth as pressing play.
            </p>
        ...
        <div className="mb-8 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              A shelf of reader-loved titles, tuned for quick discovery.
            </p>
          </div>
          <Link href="/books" className="text-sm font-bold text-primary hover:underline">
            View all
          </Link>
        </div>
